...
import static no.nav.fo.veilarbregistrering.config.RemoteFeatureConfig.UNLEASH_URL_PROPERTY;
...
public class TestContext {
    ...
    public static void setup() {
        ...
        setProperty(UNLEASH_URL_PROPERTY, "https://unleash.nais.adeo.no/api/");
