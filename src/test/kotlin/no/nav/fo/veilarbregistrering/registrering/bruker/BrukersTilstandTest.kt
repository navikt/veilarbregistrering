...
class BrukersTilstandTest {
    ...
    fun `Kjente ulikheter i oppfolgingsstatus får samme utfall i registreringstype`() {
        ...
        val ukjentBrukerNyKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=false, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("IVURD"), rettighetsgruppe=Rettighetsgruppe("IYT"))

        assertThat(beregnRegistreringType(ukjentBrukerGammelKilde)).isEqualTo(beregnRegistreringType(ukjentBrukerNyKilde))

        val kanReaktiveresNullGammelKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("IVURD"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        val kanReaktiveresFalseNyKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=false, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("IVURD"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        ...
        val ARBSGammelKilde = Oppfolgingsstatus(isUnderOppfolging=true, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.ARBEIDSSOKER, servicegruppe=Servicegruppe("BFORM"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        val ISERVNyKilde = Oppfolgingsstatus(isUnderOppfolging=true, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("BFORM"), rettighetsgruppe=Rettighetsgruppe("IYT"))

        assertThat(beregnRegistreringType(ARBSGammelKilde)).isEqualTo(beregnRegistreringType(ISERVNyKilde))

        val underOppfolgingArenaKoderGammelKilde = Oppfolgingsstatus(isUnderOppfolging=true, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=true, formidlingsgruppe=Formidlingsgruppe.IKKE_ARBEIDSSØKER, servicegruppe=Servicegruppe("VURDI"), rettighetsgruppe=Rettighetsgruppe("IYT"))
    ...
    fun `Ulikheter som trigger avvik i registreringstype`() {
        val kanReaktiveresNullGammelKilde2 = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("BFORM"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        val kanReaktiveresTrueNyKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=true, erSykmeldtMedArbeidsgiver=false, formidlingsgruppe=Formidlingsgruppe.IKKE_SERVICEBRUKER, servicegruppe=Servicegruppe("BFORM"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        ...
        val ukjentBrukerGammelKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=null, formidlingsgruppe=null, servicegruppe=null, rettighetsgruppe=null)
        val erSykmeldtMedArbeidsgiverTrueNyKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=true, formidlingsgruppe=Formidlingsgruppe.IKKE_ARBEIDSSØKER, servicegruppe= Servicegruppe("VURDI"), rettighetsgruppe=Rettighetsgruppe("IYT"))
        ...
        val ikkeUnderOppfolgingArenaKoderGammelKilde = Oppfolgingsstatus(isUnderOppfolging=false, kanReaktiveres=null, erSykmeldtMedArbeidsgiver=true, formidlingsgruppe=Formidlingsgruppe.IKKE_ARBEIDSSØKER, servicegruppe=Servicegruppe("VURDI"), rettighetsgruppe=Rettighetsgruppe("IYT"))
