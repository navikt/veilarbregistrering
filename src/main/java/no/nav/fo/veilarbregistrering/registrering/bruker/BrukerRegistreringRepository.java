...
public class BrukerRegistreringRepository {
    ...
    public BrukerRegistreringRepository(JdbcTemplate db) {
        this.db = db;
    }
    ...
    public OrdinaerBrukerRegistrering hentBrukerregistreringForId(long brukerregistreringId) {
        return SqlUtils.select(db, BRUKER_REGISTRERING, BrukerRegistreringRepository::brukerRegistreringMapper)
    ...
    public SykmeldtRegistrering hentSykmeldtregistreringForAktorId(AktorId aktorId) {
        return SqlUtils.select(db, SYKMELDT_REGISTRERING, BrukerRegistreringRepository::sykmeldtRegistreringMapper)
                .where(WhereClause.equals(AKTOR_ID, aktorId.getAktorId()))
