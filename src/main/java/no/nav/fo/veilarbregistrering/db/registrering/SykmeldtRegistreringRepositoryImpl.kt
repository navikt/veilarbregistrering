...
class SykmeldtRegistreringRepositoryImpl(private val db: NamedParameterJdbcTemplate) :
    ...
    override fun lagreSykmeldtBruker(bruker: SykmeldtRegistrering, aktorId: AktorId): Long {
        ...
        val params = mapOf(
                ...
                "opprettet" to valueOf(LocalDateTime.now()),
    ...
    companion object {
        ...
        const val SYKMELDT_REGISTRERING = "SYKMELDT_REGISTRERING"
        const val SYKMELDT_REGISTRERING_SEQ = "SYKMELDT_REGISTRERING_SEQ"
