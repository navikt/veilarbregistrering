...
import static no.nav.fo.veilarbregistrering.bruker.pdl.AuthUtils.basicCredentials;

public class OidcSystemUserTokenProvider {
    ...
    public OidcSystemUserTokenProvider(String discoveryUrl, String srvUsername, String srvPassword) {
    ...
    public OidcSystemUserTokenProvider(String tokenEndpoint, String srvUsername, String srvPassword, Client client) {
