        ...
        try {
            ...
            alleFnr.forEach {
                ...
                val identer = try {
                    ...
                    logger.warn("Fant ikke identer i PDL for person, går videre til neste person i jobben")
                ...
                arbeidssoker.allePerioder()
                    ...
                    .forEach { periode ->
                        arbeidssokerperiodeService.lagrePeriode(
                            gjeldendeFnr,
                            periode.fraDato,
                            periode.tilDato
                        )
            ...
            logger.info("Fullført jobb for populering av perioder")
        } finally {
            MDC.clear()
        }
    }
